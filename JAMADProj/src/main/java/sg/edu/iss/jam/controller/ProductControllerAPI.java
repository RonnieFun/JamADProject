...
//	@GetMapping("/shop")
//	public ResponseEntity shopLandingPage(Model model) {
...
//		
//		public ResponseEntity<?> courseList(Model model) {
//			return new ResponseEntity<>(adservice.getCourses(), HttpStatus.OK);
//		}
//
